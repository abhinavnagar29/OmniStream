...
// Must match Xenova/all-MiniLM-L6-v2's output dimension (384) so that the
// deterministic fallback and the real transformer embedding are always
// interchangeable in the `content.embedding vector(384)` column.
